      ...
      <div className="container-standard">
        <div className="section-inner">
          ...
          >
            ...
            >
              <div className="relative aspect-[16/10] w-full overflow-hidden rounded-[16px] max-md:shadow-none md:shadow-2xl after:pointer-events-none after:absolute after:inset-0 after:bg-[rgba(21,111,122,0.5)]">
                <Image
                  src="/multichain-liquidity-mobile.webp"
                  alt="Elementa Multi Chain Liquidity"
                  width={400}
                  height={400}
                  sizes="(max-width: 767px) 383px, 0px"
                  className="h-full w-full object-cover md:hidden"
                  loading="lazy"
                />
                <Image
                  src="/multichain-liquidity.webp"
                  alt="Elementa Multi Chain Liquidity"
                  width={800}
                  height={800}
